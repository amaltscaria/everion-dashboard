...
const image = {
  ...
  width: 1400,
  height: 4082,
  alt: 'Everion Device Dashboard'
}

export default function EverionDashboard() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-xl font-bold text-white">Everion Dashboard</div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <ScrollAnimation>
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-4">IoT device management dashboard</p>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">Real-time data visualization and device monitoring</p>
            </div>
          </ScrollAnimation>

          <ScrollAnimation delay={0.2}>
            <div className="mt-12 flex flex-wrap justify-center gap-3">
              {['IoT Dashboard', 'Data Visualization', 'Enterprise UX', 'Figma', 'UI/UX Design', 'Real-time Monitoring'].map((tech, index) => (
      ...
      <footer className="relative bg-gradient-to-br from-zinc-900 to-black text-white py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <p className="text-gray-500 text-sm">© 2025 Everion Dashboard. Crafted with passion for exceptional user experiences.</p>
          </div>
        </div>
      </footer>
